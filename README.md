...
# 기타
- 🏀 React를 이용한 이커머스 사이트(기여도 100%)
- ⚾️ 2023.09.01 정보처리기사 자격증 취득 (한국산업인력공단)
- 🏀 OMV 개인 NAS 서버 구축
- 🏀 2023.05.27 ~ 2023.06.03 Chat GPT를 활용한 영어 회화 서비스(기여도 100%, 담당 업무 : **Open AI API 활용**)
- 🏀 2023 - 현재 Github 블로그를 이용한 온라인 포트폴리오 웹사이트[방문하기]("https://grokeen.github.io)(기여도 100%, 담당 업무 : **Git, Markdown, Liquid 문법과 YAML Front Matter 활용**)
...
- ⚾️ 2021.06.14 ~ 2021.11.18 KIC 캠퍼스, 실무 프로젝트 기반 빅데이터 플랫폼 개발 및 분석 전문가 양성 과정 교육 이수
  ...
  a. 🏀 2021.10.24 ~ 2021.11.17 Django를 이용한 초보 개발자 이력서/자소서 도움 사이트(기여도 50%, KIC 캠퍼스, 담당 임무 : **웹 크롤링, 데이터 수집, Django, 프론트엔드**)
  b. 🏀 2021.08.30 ~ 2021.09.23 Spring 프레임워크를 이용한 음식점 예약 웹 사이트(기여도 40%, KIC 캠퍼스, 담당 업무 :  **프론트엔드, 예약 기능 구현**)
